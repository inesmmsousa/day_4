...
#         self.re_reverse_comp_pattern_1 = re.compile(self.get_expansion_bases(pattern_1, True))
#         self.re_reverse_comp_pattern_2 = re.compile(self.get_expansion_bases(pattern_2, True))
#         
